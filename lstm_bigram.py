...
# simple LSTM model working over bigrams with embedding lookup and dropouts in the inputs/outputs
num_nodes = 64
...
with graph.as_default():
    ...
    sample_in_index = tf.argmax(sample_input[0], dimension=1) + vocabulary_size * \

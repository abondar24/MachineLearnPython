...
def model(data):
    ...
    conv = tf.nn.conv2d(hidden, weights2, [1, 2, 2, 1], padding='SAME')
...
# Convolution network with two layers followed by one fully connected layer(using stride 2)
graph = tf.Graph()
...
with tf.Session(graph=graph) as session:
    ...
    print('Convolution neural network initialized')
